...
public class ObservableScrollView extends HorizontalScrollView {
	...
	public interface OnScrollListener {
        ...
        void onTouchScrollDonw(int x, int y);

        void onTouchScrollUp(int x, int y);
    }
    ...
    private void handleDownEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mIsTouched = true;
                if (mOnScrollListener != null) {
                    mOnScrollListener.onTouchScrollDonw(this.getScrollX(), this.getScrollY());
                }
                break;
        }
    }
    ...
    private void handleUpEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                restartCheckStopTiming();
                if (mOnScrollListener != null) {
                    mOnScrollListener.onTouchScrollUp(this.getScrollX(), this.getScrollY());
                }
                break;
        }
    }

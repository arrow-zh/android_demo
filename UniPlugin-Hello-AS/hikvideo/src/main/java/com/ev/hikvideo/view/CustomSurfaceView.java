...
public class CustomSurfaceView extends SurfaceView {
	...
	public void setOnZoomListener(OnZoomListener listener) {
		...
		if (mZoomListener == null) {
			mVirtualRect.setValue(mOriginalRect.getLeft(), mOriginalRect.getTop(), mOriginalRect.getRight(), mOriginalRect.getBottom());
	...
	public interface OnZoomListener {
		void onZoomChange(CustomRect oRect, CustomRect curRect);
	}
